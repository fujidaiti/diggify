...
final getListenLaterItemsProvider = Provider(GetListenLaterItems.new);

class GetListenLaterItems {
  const GetListenLaterItems(this._ref);
  ...
  Future<List<ListenLaterItem>> call({
    ...
    throw UnimplementedError(
      'TODO: Implement GetListenLaterItems',
    );
  }
}
